    ...
    <div className="flex h-screen flex-col">
      <header className="flex h-14 shrink-0 items-center border-b border-border bg-background px-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-base font-semibold">Qwen2.5-Coder</span>
                ...
                <Card className="flex flex-col border-border bg-card/50">
                  <CardHeader className="flex-row items-center justify-between py-3">
                    ...
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={copyToClipboard} disabled={!outputCode}>
                        <Copy className="h-4 w-4" />
                      </Button>
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={downloadCode} disabled={!outputCode}>
                  ...
                  <CardContent className="flex-1 p-0">
                    <Editor
                      height="100%"
                      language={activeTab === "explain" || activeTab === "debug" ? "markdown" : language}
                      theme="vs-dark"
                      value={outputCode}
                      options={{
                        readOnly: true,
