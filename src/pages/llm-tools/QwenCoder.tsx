...
const modelSizes = [
  { id: "0.5b", name: "0.5B", speed: "Ultra Fast" },
  { id: "1.5b", name: "1.5B", speed: "Fast" },
  { id: "7b", name: "7B ⭐", speed: "Balanced" },
  { id: "14b", name: "14B", speed: "Accurate" },
  { id: "32b", name: "32B", speed: "Maximum" },
];
...
const QwenCoder = () => {
  ...
  const selectedModel = modelSizes.find(m => m.id === modelSize);
    ...
    <div className="flex h-screen flex-col">
      ...
      <header className="flex h-12 shrink-0 items-center justify-between border-b border-border bg-background px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium">Qwen2.5-Coder</span>
          ...
          <div className="flex flex-1 flex-col items-center justify-center px-4">
            <div className="max-w-2xl text-center">
              <h1 className="mb-2 text-3xl font-semibold">
                ...
                I'm Qwen2.5-Coder
                <br />
                and I beat GPT-4 at coding.
              </h1>
              <p className="mb-8 text-muted-foreground">
                Give me a task and watch the magic happen.
              </p>
          ...
          <div className="mx-auto max-w-3xl">
            <div className="relative rounded-xl border border-border bg-muted/50 focus-within:border-primary/50 focus-within:ring-1 focus-within:ring-primary/50">
              <Textarea
                ...
                placeholder="Give Qwen a task to work on..."
